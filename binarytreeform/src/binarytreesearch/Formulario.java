...
public class Formulario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Binary Tree Artists");
     ...
     String csvFile = "dados.csv";
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(csvFile))) {
            while ((line = br.readLine()) != null) {
                ...
                artista.setPosicao(Integer.parseInt(leitura[0]));
                artista.setNome(leitura[1]);
                int qtd = tree.add(artista);
                listMostraDados.append("Comparações: " + qtd +"\n");
                
            }// fim percurso no arquivo
            String studentData = tree.getDadosArtistaPreOrder();
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
       Artista artista = new Artista();
       artista.setPosicao(Integer.parseInt(txtCodigo.getText()));
       artista.setNome(txtNome.getText());
       
       int qtd = tree.add(artista);
       String dadosArtista = tree.getDadosArtistaPreOrder();
       listMostraDados.setText("");
       listMostraDados.append("Comparações para inserção: " + qtd + "\n");
       listMostraDados.append(dadosArtista);
